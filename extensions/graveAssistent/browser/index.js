...
module.exports = {
        ...
        init: function () {
                ...
                var flattenObject = function (obj) {
                    ...
                    Object.keys(obj).forEach((key) => {
                        if (Array.isArray(obj[key]) && obj[key] !== null) {
                            ...
                            flattened[key] = obj[key].map(item => {
                ...
                var handleGeometry = function (obj) {
                    ...
                    if (flat.hasOwnProperty('posList')) {
                    ...
                    } else if (flat.hasOwnProperty('surfaceMember')) {
                        //console.log(flat)
                        geomObj.coordinates = []
                        flat.surfaceMember.forEach(function (item) {
                            if (item.hasOwnProperty('value')) {
                                let ring = item.value.split(' ').map(Number).chunk(dim)
                                geomObj.coordinates.push([ring])
                            }
                        })
                        ...
                        console.log('graveAssistent - handleGeometry - no coordinates found', flat, obj)
                    }
                ...
                var applyFilter = function (filter) {
                    for (let layerKey in filter) {
                        ...
                        try {
                            ...
                            api.filter(layerKey, filter[layerKey]);
                ...
                class GraveAssistent extends React.Component {
                    ...
                    componentDidMount() {
                        ...
                        backboneEvents.get().on(`off:${exId} reset:all`, () => {
                            console.log('Clearing graveAssistent')
                            me.setState({
                                active: false
                            });
                            ...
                            DClayers.forEach(l => {
                                try {
                                    ...
                                    // do nothing - we remove it to be nice
                                }
                            })
                        });
                                            ...
                                            <div className="form-group p-4">
                                                <div id="graveAssistent-feature-select-container" className="w-80 mx-auto my-2">
                                                    ...
                                                    <div id="graveAssistent-feature-dropzone" className="w-80 mx-auto">
                                                        <Dropzone className="d-grid align-items-center bg-body-tertiary" onDrop={acceptedFiles => _self.onDrop(acceptedFiles)} style={{height: '160px', borderRadius:'10px', border: '1px dashed var(--bs-primary)'}}>
